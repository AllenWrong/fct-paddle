...
def get_policy(optimizer: paddle.optimizer.Optimizer,
               algorithm: str,
               **kwargs) -> Callable:
...
def assign_learning_rate(optimizer: paddle.optimizer.Optimizer,
                         new_lr: float) -> None:
...
def constant_lr(optimizer: paddle.optimizer.Optimizer,
                warmup_length: int,
                lr: float,
                **kwargs) -> Callable:
...
def cosine_lr(optimizer: paddle.optimizer.Optimizer,
              warmup_length: int,
              epochs: int,
              lr: float,
              **kwargs) -> Callable:
...
def multistep_lr(optimizer: paddle.optimizer.Optimizer,
                 lr_gamma: float,
                 lr_adjust: int,
                 lr: float,
                 **kwargs) -> Callable:
